...
load('datos/r-image-ws-list.RData') # Download this image from
load('datos/r-image-site-selection.RData') # Download this image from
...
esc_100_150_250_activas_buenas_mapa_eng <- plot_grid(
  ...
  esc_150_activas_buenas_mapa_eng +
    ...
    labs(
      title = bquote(
        "Scenario 2: one station per 150 "*km^2~". Total proposed: "*.(last(esc_150_activas_buenas_df_resumen$n)))) +
    coord_sf(xlim = lims_rd_buffer_utm[grepl('^x', names(lims_rd_buffer_utm))],
           ylim = lims_rd_buffer_utm[!grepl('^x', names(lims_rd_buffer_utm))]),
  esc_250_activas_buenas_mapa_eng +
    ...
    labs(
      title = bquote(
        "Scenario 3: one station per 250 "*km^2~". Total proposed: "*.(last(esc_250_activas_buenas_df_resumen$n)))) +
    coord_sf(xlim = lims_rd_buffer_utm[grepl('^x', names(lims_rd_buffer_utm))],
           ylim = lims_rd_buffer_utm[!grepl('^x', names(lims_rd_buffer_utm))]),
  ncol = 1)
...
The R scripts and typesetting files used to produce this paper, including styles, BibTeX entries for citations, figures, and tables, are available at \url{https://github.com/geofis/seleccion-sitios-estaciones-meteoclimaticas-rd}. Scripts for data curation, processing, and analysis are accessible at \url{https://github.com/geofis/datos-meteoclimaticos-escenarios-cc} and on Zenodo at \url{https://doi.org/10.5281/zenodo.14571957}. Additionally, the R images (serialized representations of R objects stored in `.Rdata` files) required to reproduce both the analyses and the paper itself are available at \url{https://doi.org/10.5281/zenodo.14574177}.
...
```{r lastchunk_sessionInfo, echo=F, include=F, eval=F}
sessionInfo()
...
# 
# locale:
#  [1] LC_CTYPE=es_DO.UTF-8       LC_NUMERIC=C               LC_TIME=es_DO.UTF-8       
#  [4] LC_COLLATE=es_DO.UTF-8     LC_MONETARY=es_DO.UTF-8    LC_MESSAGES=es_DO.UTF-8   
#  [7] LC_PAPER=es_DO.UTF-8       LC_NAME=C                  LC_ADDRESS=C              
# [10] LC_TELEPHONE=C             LC_MEASUREMENT=es_DO.UTF-8 LC_IDENTIFICATION=C       
# 
...
#  [1] glue_1.6.2           ggspatial_1.1.8      scales_1.3.0         RColorBrewer_1.1-3  
#  [5] lemon_0.5.0          cowplot_1.1.1        viridis_0.6.3        viridisLite_0.4.2   
#  [9] patchwork_1.3.0      janitor_2.2.0        ahpsurvey_0.4.1      lubridate_1.9.3     
# [13] forcats_1.0.0        stringr_1.5.0        dplyr_1.1.4          purrr_1.0.1         
# [17] readr_2.1.4          tidyr_1.3.0          tibble_3.2.1         ggplot2_3.5.1       
# [21] tidyverse_2.0.0      kableExtra_1.3.4     psych_2.3.3          fuzzyjoin_0.1.6     
# [25] parzer_0.4.1         readxl_1.4.2         readODS_1.8.0        mapview_2.11.0      
# [29] leaflet.extras_1.0.0 leaflet_2.1.2        spdep_1.3-5          spData_2.3.1        
# [33] sf_1.0-12            raster_3.6-26        sp_2.1-4            
# 
# loaded via a namespace (and not attached):
#  [1] Rdpack_2.4         DBI_1.1.3          mnormt_2.1.1       deldir_1.0-9      
#  [5] gridExtra_2.3      s2_1.1.4           rlang_1.1.4        magrittr_2.0.3    
#  [9] snakecase_0.11.0   e1071_1.7-13       compiler_4.3.0     png_0.1-8         
# [13] systemfonts_1.0.4  vctrs_0.6.5        rvest_1.0.3        crayon_1.5.2      
# [17] pkgconfig_2.0.3    wk_0.7.3           fastmap_1.1.1      leafem_0.2.0      
# [21] utf8_1.2.3         rmarkdown_2.21     tzdb_0.4.0         xfun_0.39         
# [25] satellite_1.0.4    terra_1.7-78       parallel_4.3.0     R6_2.5.1          
# [29] stringi_1.7.12     boot_1.3-28        cellranger_1.1.0   Rcpp_1.0.10       
# [33] knitr_1.42         base64enc_0.1-3    timechange_0.2.0   tidyselect_1.2.0  
# [37] rstudioapi_0.14    codetools_0.2-18   lattice_0.20-45    plyr_1.8.9        
# [41] withr_2.5.0        evaluate_0.21      units_0.8-2        proxy_0.4-27      
# [45] xml2_1.3.4         pillar_1.9.0       KernSmooth_2.23-20 stats4_4.3.0      
# [49] generics_0.1.3     hms_1.1.3          munsell_0.5.0      class_7.3-20      
# [53] tools_4.3.0        webshot_0.5.4      grid_4.3.0         rbibutils_2.2.13  
# [57] crosstalk_1.2.0    colorspace_2.1-0   nlme_3.1-155       cli_3.6.1         
# [61] fansi_1.0.4        svglite_2.1.1      gtable_0.3.5       digest_0.6.31     
# [65] classInt_0.4-9     htmlwidgets_1.6.2  farver_2.1.1       htmltools_0.5.5   
# [69] lifecycle_1.0.3    httr_1.4.6    
```
